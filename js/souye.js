...
//向上滚动
			...
			document.getElementById("box-b-a").style.height=bodyHeight*0.2+"px";
			document.getElementById("box-b-b").style.height=bodyHeight*0.1+"px";
			document.getElementById("box-b-c").style.height=bodyHeight*0.1+"px";
